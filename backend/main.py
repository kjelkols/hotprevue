...
from api import admin, ai, collections, events, file_copy, input_sessions, machines, photographers, photos, searches, settings as settings_api, shortcuts, stats, system, tags, text_items  # noqa: E402
